...
public class AutoTarget extends Command {
  ...
  public AutoTarget(Limelight visionSubsystem, SwerveSubsystem swerveSubsystem, ShooterPivot shooterPivot) {
  ...
  public void execute() {
    ...
    // PIDController turnController = new PIDController(xSpeed, ySpeed,
    // turningSpeed);
    // turnController.calculate(swerveSubsystem.getHeading(),
    // swerveSubsystem.getHeading() + limelightSubsystem.getTx());
    if (isFinished()) {
